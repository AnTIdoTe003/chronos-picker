        ...
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://npmjs.com/package/@chronos/picker" target="_blank" rel="noopener noreferrer" aria-label="npm">
                <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-links">
            ...
            <div className="footer-links-group">
              ...
              <a href="https://npmjs.com/package/@chronos/picker" target="_blank" rel="noopener noreferrer">
                npm Package
              </a>
