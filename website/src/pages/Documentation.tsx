    ...
    <div className="documentation">
      <div className="doc-hero">
        <div className="container container-narrow">
          <h1>Documentation</h1>
          <p>Everything you need to know about using Chronos Picker in your React projects.</p>
        </div>
      </div>
      ...
      <div className="container doc-container">
        <aside className="doc-sidebar">
          <nav className="doc-nav">
            <a href="#installation" className="doc-nav-link">Installation</a>
            <a href="#quick-start" className="doc-nav-link">Quick Start</a>
            <a href="#props" className="doc-nav-link">Props</a>
            <a href="#types" className="doc-nav-link">Types</a>
            <a href="#utilities" className="doc-nav-link">Utility Functions</a>
            <a href="#timezones" className="doc-nav-link">Timezones</a>
            <a href="#styling" className="doc-nav-link">Styling</a>
            <a href="#accessibility" className="doc-nav-link">Accessibility</a>
            <a href="#examples" className="doc-nav-link">Examples</a>
          </nav>
        </aside>
        ...
        <main className="doc-content">
          <section id="installation" className="doc-section">
            <h2>Installation</h2>
            <p>Install Chronos Picker and its peer dependency Luxon via npm, yarn, or pnpm:</p>
            
            <CodeBlock language="bash" code="npm install @chronos/picker luxon" />
            
            <p>Or with yarn:</p>
            <CodeBlock language="bash" code="yarn add @chronos/picker luxon" />
          </section>
...
function App() {
  ...
  return (
    ...
    />
          ...
          <section id="props" className="doc-section">
            <h2>Props</h2>
            <p>Complete list of props accepted by the DateTimePicker component:</p>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><code>Date | string | DateTime</code></td>
                    <td><code>undefined</code></td>
                    <td>Current selected value</td>
                  </tr>
                  <tr>
                    <td><code>onChange</code></td>
                    <td><code>(value: DateTimeValue) =&gt; void</code></td>
                    <td><code>undefined</code></td>
                  ...
                  <tr>
                    ...
                    <td><code>string</code></td>
                    <td><code>"Select date and time"</code></td>
                  ...
                  <tr>
                    ...
                    <td><code>string</code></td>
                    <td><code>"Date and time picker"</code></td>
                    <td>ARIA label</td>
                  </tr>
                  <tr>
                    <td><code>showTimezoneSelector</code></td>
                    <td><code>boolean</code></td>
                    <td><code>false</code></td>
  ...
  showTimezoneSelector?: boolean;
          ...
          <section id="utilities" className="doc-section">
            ...
            <CodeBlock 
              language="typescript"
              code={`import { convertToTimezone } from '@chronos/picker';
...
console.log(tokyo.toISO());`}
            ...
            <CodeBlock 
              language="typescript"
              code={`import { nowInTimezone } from '@chronos/picker';
...
const nowInNY = nowInTimezone('America/New_York');`}
          ...
          <section id="timezones" className="doc-section">
            ...
            <p>Chronos Picker supports all IANA timezone identifiers (400+). Common timezones include:</p>
            
            <ul className="timezone-list">
              <li><code>Asia/Kolkata</code> - India (IST) - Default</li>
              <li><code>America/New_York</code> - Eastern Time (ET)</li>
              <li><code>America/Chicago</code> - Central Time (CT)</li>
              <li><code>America/Los_Angeles</code> - Pacific Time (PT)</li>
              <li><code>Europe/London</code> - London (GMT/BST)</li>
              <li><code>Europe/Paris</code> - Central Europe (CET)</li>
              <li><code>Asia/Tokyo</code> - Tokyo (JST)</li>
              <li><code>Australia/Sydney</code> - Sydney (AEDT)</li>
              <li><code>UTC</code> - Coordinated Universal Time</li>
            </ul>
            
            <p>View the complete list at <a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones" target="_blank" rel="noopener noreferrer">IANA timezone database</a>.</p>
          </section>
...
/>`}
          ...
          <section id="accessibility" className="doc-section">
            ...
            <ul>
              <li><strong>Keyboard Navigation:</strong> Full support for Tab, Enter, Space, Arrow keys, and Escape</li>
              <li><strong>ARIA Labels:</strong> Comprehensive labels for screen readers</li>
              <li><strong>Focus Management:</strong> Proper focus indicators and tab order</li>
              <li><strong>WCAG 2.1:</strong> Meets AA level compliance</li>
            </ul>
...
/>`}
            ...
            <div className="doc-cta">
              ...
              <p>Check out our comprehensive examples page with interactive demos.</p>
